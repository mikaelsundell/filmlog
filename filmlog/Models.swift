...
struct CameraUtils {
    ...
    static let filmSizes: [FilmSize] = [
        ...
        FilmSize(name: "Super 35 (4-perf Anamorphic 2x)", category: "Motion Picture Film (Anamorphic)", width: 24.89 * 2.0, height: 18.66),
        FilmSize(name: "Super 35 (3-perf Anamorphic 2x)", category: "Motion Picture Film (Anamorphic)", width: 24.89 * 2.0, height: 13.87),
        FilmSize(name: "Super 35 (4-perf Anamorphic 1.5x)", category: "Motion Picture Film (Anamorphic)", width: 24.89 * 1.5, height: 18.66),
        FilmSize(name: "Super 35 (3-perf Anamorphic 1.5x)", category: "Motion Picture Film (Anamorphic)", width: 24.89 * 1.5, height: 13.87),
