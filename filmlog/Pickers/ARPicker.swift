...
struct ARPicker: View {
    ...
    @State private var localFiles: [SharedStorageFile] = []
    ...
    private func sortFiles(_ files: [SharedStorageFile], by option: SortOption) -> [SharedStorageFile] {
        switch option {
        case .name:
    ...
    private var filteredFiles: [SharedStorageFile] {
    ...
    private func reloadFiles() {
        localFiles = loadSharedStorageFiles(kind: .ar)
    }
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showImporter) {
            FilePicker(kind: .ar, allowsMultiple: false) { urls in
                ...
                if let saved = saveToSharedStorage(importedURL, as: .ar) {
...
struct FileGridItem: View {
    @ObservedObject var file: SharedStorageFile
